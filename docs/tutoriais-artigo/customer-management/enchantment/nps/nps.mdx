...
Acesse a página de NPS localizada no menu lateral na sessão de **Encantamento**.Isso o levará para a página de configurações das pesquisas NPS.
...
Você pode selecionar uma mensagem personalizada de agradecimento, clique <a a href="/docs/tutoriais-artigo/customer-management/nps/thanks-message" className="text-blue-500 font-bold">aqui</a>. para saber mais sobre.
...
Você pode selecionar template de email personalizado, clique <a href="/docs/tutoriais-artigo/customer-management/nps/email-templates" className="text-blue-500 font-bold">aqui</a>. para saber mais sobre.
